...
Mock.mock(/\/pit\/basic-data\/enterprise\/list.api/, 'post', getEnterpriseList)
Mock.mock(/\/pit\/basic-data\/enterprise\/single.api/, 'post', getEnterprise)
Mock.mock(/\/pit\/basic-data\/enterprise\/delete.api/, 'post', deleteEnterpriseById)
Mock.mock(/\/pit\/basic-data\/enterprise\/save.api/, 'post', saveEnterprise)
Mock.mock(/\/pit\/basic-data\/staff\/list.api/, 'post', getStaffList)
Mock.mock(/\/pit\/basic-data\/staff\/single.api/, 'post', getStaff)
Mock.mock(/\/pit\/basic-data\/staff\/delete.api/, 'post', deleteStaffById)
Mock.mock(/\/pit\/basic-data\/staff\/save.api/, 'post', saveStaff)
Mock.mock(/\/pit\/basic-data\/staff\/login-id\/save.api/, 'post', saveStaffLoginId)
Mock.mock(/\/pit\/basic-data\/salary\/single.api/, 'post', getSalary)
Mock.mock(/\/pit\/basic-data\/salary\/save.api/, 'post', saveSalary)
Mock.mock(/\/pit\/basic-data\/pay-fiducial\/list.api/, 'post', getFiducialList)
Mock.mock(/\/pit\/basic-data\/pay-fiducial\/single.api/, 'post', getFiducial)
Mock.mock(/\/pit\/basic-data\/pay-fiducial\/delete.api/, 'post', deleteFiducialById)
Mock.mock(/\/pit\/basic-data\/pay-fiducial\/save.api/, 'post', saveFiducial)
Mock.mock(/\/pit\/basic-data\/pay-ratio\/list.api/, 'post', getRatioList)
Mock.mock(/\/pit\/basic-data\/pay-ratio\/single.api/, 'post', getRatio)
Mock.mock(/\/pit\/basic-data\/pay-ratio\/delete.api/, 'post', deleteRatioById)
Mock.mock(/\/pit\/basic-data\/pay-ratio\/save.api/, 'post', saveRatio)
Mock.mock(/\/pit\/basic-data\/tax-stair\/list.api/, 'post', getTaxStairList)
Mock.mock(/\/pit\/basic-data\/tax-stair\/single.api/, 'post', getTaxStair)
Mock.mock(/\/pit\/basic-data\/tax-stair\/delete.api/, 'post', deleteTaxStairById)
Mock.mock(/\/pit\/basic-data\/tax-stair\/save.api/, 'post', saveTaxStair)
Mock.mock(/\/pit\/additional-deduct\/child-educate\/list.api/, 'post', getChildEducateList)
Mock.mock(/\/pit\/additional-deduct\/child-educate\/single.api/, 'post', getChildEducate)
Mock.mock(/\/pit\/additional-deduct\/child-educate\/delete.api/, 'post', deleteChildEducateById)
Mock.mock(/\/pit\/additional-deduct\/child-educate\/save.api/, 'post', saveChildEducate)
Mock.mock(/\/pit\/additional-deduct\/adult-educate\/list.api/, 'post', getAdultEducateList)
Mock.mock(/\/pit\/additional-deduct\/adult-educate\/single.api/, 'post', getAdultEducate)
Mock.mock(/\/pit\/additional-deduct\/adult-educate\/delete.api/, 'post', deleteAdultEducateById)
Mock.mock(/\/pit\/additional-deduct\/adult-educate\/save.api/, 'post', saveAdultEducate)
Mock.mock(/\/pit\/additional-deduct\/house-loan\/list.api/, 'post', getHouseLoanList)
Mock.mock(/\/pit\/additional-deduct\/house-loan\/single.api/, 'post', getHouseLoan)
Mock.mock(/\/pit\/additional-deduct\/house-loan\/delete.api/, 'post', deleteHouseLoanById)
Mock.mock(/\/pit\/additional-deduct\/house-loan\/save.api/, 'post', saveHouseLoan)
Mock.mock(/\/pit\/additional-deduct\/house-rent\/list.api/, 'post', getHouseRentList)
Mock.mock(/\/pit\/additional-deduct\/house-rent\/single.api/, 'post', getHouseRent)
Mock.mock(/\/pit\/additional-deduct\/house-rent\/delete.api/, 'post', deleteHouseRentById)
Mock.mock(/\/pit\/additional-deduct\/house-rent\/save.api/, 'post', saveHouseRent)
Mock.mock(/\/pit\/additional-deduct\/support-aged\/list.api/, 'post', getSupportAgedList)
Mock.mock(/\/pit\/additional-deduct\/support-aged\/single.api/, 'post', getSupportAged)
Mock.mock(/\/pit\/additional-deduct\/support-aged\/delete.api/, 'post', deleteSupportAgedById)
Mock.mock(/\/pit\/additional-deduct\/support-aged\/save.api/, 'post', saveSupportAged)
Mock.mock(/\/pit\/additional-deduct\/medical\/list.api/, 'post', getMedicalList)
Mock.mock(/\/pit\/additional-deduct\/medical\/single.api/, 'post', getMedical)
Mock.mock(/\/pit\/additional-deduct\/medical\/delete.api/, 'post', deleteMedicalById)
Mock.mock(/\/pit\/additional-deduct\/medical\/save.api/, 'post', saveMedical)
Mock.mock(/\/pit\/calc\/salary-snapshoot\/list.api/, 'post', getSalarySnapshootList)
Mock.mock(/\/pit\/calc\/salary-snapshoot\/single.api/, 'post', getSalarySnapshoot)
Mock.mock(/\/pit\/calc\/salary-snapshoot\/delete.api/, 'post', deleteSalarySnapshootById)
Mock.mock(/\/pit\/calc\/salary-snapshoot\/save.api/, 'post', saveSalarySnapshoot)
Mock.mock(/\/pit\/calc\/salary-snapshoot\/update-id.api/, 'post', updateSalarySnapshootById)
Mock.mock(/\/pit\/calc\/salary-snapshoot\/update-query.api/, 'post', updateSalarySnapshootByQuery)
Mock.mock(/\/pit\/calc\/salary-snapshoot\/import.api/, 'post', importSalarySnapshoot)
Mock.mock(/\/pit\/calc\/ad-snapshoot\/list.api/, 'post', getADSnapshootList)
Mock.mock(/\/pit\/calc\/ad-snapshoot\/update-id.api/, 'post', updateADSnapshootById)
Mock.mock(/\/pit\/calc\/verify\/result\/list.api/, 'post', getVerifyResultList)
Mock.mock(/\/pit\/calc\/verify\/result\/update-id.api/, 'post', updateVerifyResultById)
Mock.mock(/\/pit\/calc\/verify\/verify-id.api/, 'post', verifyById)
Mock.mock(/\/pit\/calc\/verify\/verify-query.api/, 'post', verifyByQuery)
Mock.mock(/\/pit\/calc\/payroll\/list.api/, 'post', getPayrollList)
Mock.mock(/\/pit\/calc\/payroll\/single.api/, 'post', getPayroll)
Mock.mock(/\/pit\/calc\/payroll\/update-id.api/, 'post', updatePayrollById)
Mock.mock(/\/pit\/calc\/payroll\/update-query.api/, 'post', updatePayrollByQuery)
Mock.mock(/\/pit\/calc\/flow-record\/list.api/, 'post', getFlowRecordList)
